...
import { AnatomStructType, fetchStrapiDocument } from './AnatomStruct';
...
const anatomStruct = await fetchStrapiDocument(baseURL, AnatomStructType.Osso, 'Femore destro');
deeplog(anatomStruct);
